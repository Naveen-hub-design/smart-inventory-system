    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input {...register('product_name')} className="input-field" />
        ...
        <div>
          ...
          <input {...register('size')} className="input-field" placeholder="e.g. M, L, XL, 32" />
        </div>

        <div>
          <label className="block text-sm font-medium mb-1">Color</label>
          <input {...register('color')} className="input-field" placeholder="e.g. Red, Blue" />
        </div>
        ...
        <div>
          ...
          <input {...register('quantity')} type="number" className="input-field" />
          {errors.quantity && <p className="text-red-500 text-xs">{errors.quantity.message}</p>}
        </div>

        <div>
          <label className="block text-sm font-medium mb-1">Min Stock</label>
          <input {...register('min_stock')} type="number" className="input-field" />
        </div>
        ...
        <div>
          ...
          {product?.image && <p className="text-xs text-gray-500 mt-1">Current: {product.image}</p>}
        </div>
      </div>

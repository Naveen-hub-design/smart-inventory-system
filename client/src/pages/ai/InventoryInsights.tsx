...
function SummaryCard({ title, icon: Icon, gradient, children }: { title: string; icon: any; gradient: string; children: React.ReactNode }) {
  return (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {sc?.best_selling_product && (
              <SummaryCard title="Best Selling" icon={Award} gradient={cardGradients.best_selling_product}>
            ...
            {sc?.fastest_growing_product && (
              <SummaryCard title="Fastest Growing" icon={TrendingUp} gradient={cardGradients.fastest_growing_product}>
            ...
            {sc?.slow_moving_product && (
              <SummaryCard title="Slow Moving" icon={Minus} gradient={cardGradients.slow_moving_product}>
            ...
            {sc?.overstocked_product && (
              <SummaryCard title="Overstocked" icon={Package} gradient={cardGradients.overstocked_product}>
            ...
            {sc?.highest_profit_product && (
              <SummaryCard title="Highest Profit" icon={DollarSign} gradient={cardGradients.highest_profit_product}>
            ...
            {sc?.highest_revenue_category && (
              <SummaryCard title="Top Revenue" icon={Layers} gradient={cardGradients.highest_revenue_category}>
            ...
            {sc?.stock_out_risk_product && (
              <SummaryCard title="Stock-Out Risk" icon={AlertTriangle} gradient={cardGradients.stock_out_risk_product}>
            ...
            {sc?.dead_stock_product && (
              <SummaryCard title="Dead Stock" icon={Skull} gradient={cardGradients.dead_stock_product}>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="px-5 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      ...
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Units Sold</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Revenue</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Profit</th>
                    </tr>
                  </thead>
                  <tbody>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="px-5 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      ...
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Prev Month</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Current Month</th>
                    </tr>
                  </thead>
                  <tbody>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="px-5 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      ...
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-left">AI Recommendation</th>
                    </tr>
                  </thead>
                  <tbody>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="px-5 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      ...
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-left">SKU</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Stock</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Avg Monthly Sales</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Est. Months</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-left">Recommendation</th>
                    </tr>
                  </thead>
                  <tbody>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="px-5 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      ...
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-left">SKU</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Days Unsold</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Stock Value</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-left">AI Recommendation</th>
                    </tr>
                  </thead>
                  <tbody>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="px-5 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      ...
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Sales Growth</th>
                      <th className="py-2 px-3 font-semibold text-xs uppercase tracking-wider text-right">Stock Value</th>
                    </tr>
                  </thead>
                  <tbody>
